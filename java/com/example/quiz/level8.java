...
public class level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.ygl);
        ...
        textdescription.setText(R.string.levelVosi);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(level8.this, GameLevels.class); //намерение для перехода
        ...
        textdeascriptionEnd.setText(R.string.levelVosiEnd);
        ...
        img_left.setImageResource(array.imagest8[numLeft]);
        ...
        img_right.setImageResource(array.imagest8[numRight]);
