...
public class level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.leveltre);
        ...
        textdeascriptionEnd.setText(R.string.leveltreEnd);
        ...
        img_left.setImageResource(array.imagest3[numLeft]);
        ...
        img_right.setImageResource(array.imagest3[numRight]);
