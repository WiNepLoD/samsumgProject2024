...
public class level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.err);
        ...
        textdescription.setText(R.string.levelvSeven);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(level7.this, GameLevels.class); //намерение для перехода
        ...
        textdeascriptionEnd.setText(R.string.levelSevenEnd);
        ...
        img_left.setImageResource(array.imagest7[numLeft]);
        ...
        img_right.setImageResource(array.imagest7[numRight]);
