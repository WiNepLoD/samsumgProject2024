...
public class level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.levelviwe);
        ...
        textdeascriptionEnd.setText(R.string.levelviweEnd);
        ...
        img_left.setImageResource(array.imagest5[numLeft]);
        ...
        img_right.setImageResource(array.imagest5[numRight]);
