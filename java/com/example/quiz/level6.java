...
public class level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.levelvSix);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(level6.this, GameLevels.class); //намерение для перехода
        ...
        textdeascriptionEnd.setText(R.string.levelsixEnd);
        ...
        img_left.setImageResource(array.imagest6[numLeft]);
        ...
        img_right.setImageResource(array.imagest6[numRight]);
