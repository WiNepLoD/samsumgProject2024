...
public class level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.leveltho);
        ...
        textdeascriptionEnd.setText(R.string.levelthoEnd);
        ...
        img_left.setImageResource(array.imagest4[numLeft]);
        ...
        img_right.setImageResource(array.imagest4[numRight]);
