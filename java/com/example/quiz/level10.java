...
public class level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.smilesmile);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(level10.this, GameLevels.class); //намерение для перехода
        ...
        textdeascriptionEnd.setText(R.string.levelTenEnd);
        ...
        img_left.setImageResource(array.imagest10[numLeft]);
        text_left.setText(array.texts10[numLeft]);
        ...
        img_right.setImageResource(array.imagest10[numRight]);
